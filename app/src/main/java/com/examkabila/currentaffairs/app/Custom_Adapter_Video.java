...
public class Custom_Adapter_Video extends BaseAdapter {

     private Context mContext;
    private ArrayList<Object_Video> listCate;

    public Custom_Adapter_Video(Context mContext, ArrayList<Object_Video> list){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null){
            ...
            convertView = inflater.inflate(R.layout.row_listview_video, parent, false);
       ...
       // Globals.setAppFontTextView(mContext, txtName);
        ...
        int imgheight = totalContent - ((totalContent * 83) / 100);
